<!-- GENERATED by tools/generate-plugins.py from tools/relay-lint-fixtures/fold/FD11-row-after-result-foldscope.md — kit v2.9.0. Do not edit; edit the canonical source. -->
