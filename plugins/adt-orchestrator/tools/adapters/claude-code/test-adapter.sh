...
assert_relay_version "e3-shared-vA-version-triad" "$e3_shared_root/tools/relay" "$e3_shared_root/tools" "2.9.2" "$e3_shared_a_fingerprint" || fail=1
...
if [ -z "$e3_shared_backup" ] || [ ! -d "$e3_shared_backup" ]; then
  ...
  assert_relay_version "e3-shared-backup-version-triad" "$e3_shared_backup/relay" "$e3_shared_backup" "2.9.2" "$e3_shared_a_fingerprint" || fail=1
fi
...
assert_relay_version "e3-shared-vB-version-triad" "$e3_shared_root/tools/relay" "$e3_shared_root/tools" "2.9.2" "$e3_shared_b_fingerprint" || fail=1
...
assert_relay_version "e3-plugin-update-keeps-old-version-triad" "$e3_plugin_old/tools/relay" "$e3_plugin_old/tools" "2.9.2" "$e3_plugin_old_fingerprint" || fail=1
...
assert_relay_version "e3-plugin-repoint-new-version-triad" "$e3_plugin_new/tools/relay" "$e3_plugin_new/tools" "2.9.2" "$e3_plugin_new_fingerprint" || fail=1
